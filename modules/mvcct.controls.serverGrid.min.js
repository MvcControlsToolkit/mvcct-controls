...
g.setAttribute("id",c),g.setAttribute("data-version",e),g.appendChild(a),document.body.appendChild(g));p.transform(g);jQuery(a).a({show:!1,b:"static"});a.getAttribute("data-destroy-on-close")&&jQuery(a).f("hidden.bs.modal",function(){a.expando_onSubmit=null;a.expando_onSubmitError=null;k(a.parentNode);a.parentNode.parentNode.removeChild(a.parentNode)});jQuery(a).a("show")};y=c.closeModal||function(a){jQuery(a).a("hide");a.expando_onSubmit=null;a.expando_onSubmitError=null}},"serverGrid",null);e.addOperation("save_click",
function(a){var c=a.control;if(c){var b=a.find("data-version");b&&(b=b.firstChild,a=b.expando_onSubmit,b=b.expando_onSubmitError,a&&e.postForm(c,null,null,a,b,h,m,n,l))}},"server-detail",!0);e.addOperation("close_click",function(a){a.control&&(a=a.find("data-version"))&&y(a)},"server-detail",!0);e.addOperation("delete_click",function(a){A(a,!0)},"server-immediate-grid");e.addOperation("delete_click",function(a){A(a,!1)},"server-batch-grid");e.addOperation("edit_click",function(a){B(a,!1)},"server-immediate-grid");
e.addOperation("edit-detail_click",function(a){D(a,!0)},"server-immediate-grid");e.addOperation("edit-detail_click",function(a){D(a,!1)},"server-batch-grid");e.addOperation("undo_click",function(a){B(a,!0)},"server-immediate-grid");e.addOperation("save_click",function(a){G(a)},"server-immediate-grid");e.addOperation("add_click",function(a){C(w(a),!0)},"server-immediate-grid");e.addOperation("add_click",function(a){C(w(a),!1)},"server-batch-grid");e.addOperation("add-detail_click",function(a){F(w(a),
!0)},"server-immediate-grid",!0);e.addOperation("add-detail_click",function(a){F(w(a),!1)},"server-batch-grid",!0);e.addOperation("show-detail_click",function(a){E(a)},"server-immediate-grid");e.addOperation("show-detail_click",function(a){E(a)},"server-batch-grid");return e})})()})();
